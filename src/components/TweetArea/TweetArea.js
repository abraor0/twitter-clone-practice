  ...
  return (
    <div className="px-4 flex gap-x-4">
      ...
      <div className="flex-1">
        {showTweetConfig && <button className="transition-colors hover:bg-sky-100 text-sky-500 flex items-center gap-x-1 text-[0.8125rem] border-[1px] border-gray-300 px-3 leading-relaxed rounded-full font-semibold" type="button">
          Everyone
        ...
        <span onInput={handlerInput} className="block pl-2 text-wrap-any focus-visible:outline-none text-gray-700 text-lg mb-4 mt-7" onFocus={handlerOnFocus} contentEditable="true">
          What's happening?
        </span>
